...
boolean = True #type check, primitive data type boolean
...
person = {'name': 'John', 'location': 'Salt Lake', 'age': 37, 'is_balding': False} #variable declaration, composite data type dictionary, initialize
fruit = ('blueberry', 'strawberry', 'banana') #variable declaration, composite data type list, initialize
print(type(fruit)) #
